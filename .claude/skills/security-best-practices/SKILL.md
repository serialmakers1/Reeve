...
description: Use when reviewing or writing auth logic, API endpoints, RLS policies, or any code that handles user data or permissions. Invoke PROACTIVELY before any feature that touches authentication, authorization, or external input validation. Covers OWASP Top 10, CORS, XSS, CSRF, SQL injection, and rate limiting.
metadata:
