...
function SectionLabel({ children, light = false }: { children: React.ReactNode; light?: boolean }): React.JSX.Element {
  return (
    <p
...
export default function TenantSavingsPage(): React.JSX.Element {
  ...
  return (
    <Layout>
      ...
      <section className="bg-[#0F1C2E] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            >
              Reeve lets you move into your next Bangalore home with just 2 month's deposit. Zero brokerage. No
              middlemen.
            </p>

            <div className="t-fade-up mt-8 flex flex-wrap gap-3" style={{ animationDelay: "240ms" }}>
              {["2 Month Deposit Only", "Zero Brokerage — Always", "Platform-Managed Home", "Zero SPAM Policy"].map(
                (badge) => (
                  <span
                    key={badge}
            ...
            <div className="t-fade-up mt-8 flex flex-wrap items-center gap-4" style={{ animationDelay: "320ms" }}>
              <button
            ...
            <p className="mt-5 text-sm text-slate-400 max-w-lg leading-relaxed" style={{ fontFamily: FONT_SANS }}>
              We charge a Reeve fee of 7% of each month's rent (reduced to 4% on next term). We&apos;ll show you exactly
      ...
      ────────────────────────────────────────────────────────────────────── */}
      <section ref={calculatorRef} id="calculator" className="bg-[#0F1C2E]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-28">
          ...
          <p className="mt-4 text-slate-400 text-base max-w-lg leading-7" style={{ fontFamily: FONT_SANS }}>
          ...
          <div className="mt-14 grid lg:grid-cols-[1fr_1.4fr] gap-8 items-start">
            ...
            <div className="rounded-3xl border border-slate-700/50 bg-[#1A2D42] p-6 sm:p-8">
              ...
              <p className="mt-3 text-5xl sm:text-6xl font-medium text-blue-400" style={{ fontFamily: FONT_MONO }}>
                {formatINR(rent)}
              </p>
              ...
              <div className="flex justify-between text-xs text-slate-500 mt-2" style={{ fontFamily: FONT_SANS }}>
                <span>₹20,000</span>
                <span>₹2,00,000</span>
              </div>
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {QUICK_RENTS.map((v) => {
                  const label = v === 100000 ? "₹1L" : v >= 1000 ? `₹${v / 1000}K` : formatINR(v);
                  return (
                    <button
                      key={v}
                      onClick={() => setRent(v)}
            ...
            <div className="rounded-3xl border border-slate-700/50 bg-[#1A2D42] p-6 sm:p-8">
              ...
              <div className="mt-6 w-full rounded-2xl border border-slate-700/50 overflow-hidden">
                ...
                {[
                  ...
                  <div key={row.label} className="grid grid-cols-3 px-4 py-3 border-t border-slate-700/50">
                    <p className="text-sm text-slate-400" style={{ fontFamily: FONT_SANS }}>
                      {row.label}
                    </p>
                    <p className="text-sm font-medium text-red-400 text-right" style={{ fontFamily: FONT_MONO }}>
                      {row.trad !== null ? <CountUp value={row.trad} /> : "—"}
                    </p>
                    <p className="text-sm font-medium text-blue-400 text-right" style={{ fontFamily: FONT_MONO }}>
                      {row.reeve !== null ? <CountUp value={row.reeve} /> : "₹0"}
                    </p>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-5 rounded-xl border border-slate-700/50 bg-slate-800/30 px-4 py-3">
                <p className="text-xs text-slate-500 leading-5" style={{ fontFamily: FONT_SANS }}>
                  Assumptions: 11-month tenure · Traditional deposit withheld at move-out: 1 month of rent (50% of it is
                  unfair or excessive) · Reeve fee shown at 7% (confirmed before you commit, drops to 4% on renewal)
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 hidden lg:block overflow-hidden rounded-2xl" style={{ border: "1px solid #E2E8F0" }}>
            <table className="w-full text-sm">
              <thead>
                <tr>
                  <th
                    className="px-6 py-4 text-left font-semibold text-slate-500 bg-slate-50 w-[35%]"
                    style={{ fontFamily: FONT_SANS }}
                  >
                    Aspect
                  </th>
                  <th
                    className="px-6 py-4 text-center font-semibold text-slate-600 bg-slate-50"
                    style={{ fontFamily: FONT_SANS }}
                  >
                    Traditional Renting
                  </th>
                ...
                {DIFFERENCE_ROWS.map((row, i) => (
                  ...
                  >
                    <td
                      ...
                      style={{
                        color: row.emphasized ? "#1D4ED8" : "#1E293B",
                    ...
                    <td
                      ...
                      style={{ borderBottom: "1px solid #E2E8F0", fontFamily: FONT_SANS }}
                    >
                      {row.traditional}
                    </td>
                    <td
                ...
                >
                  ...
                  >
                    <span
                      ...
                      style={{ color: row.emphasized ? "#1D4ED8" : "#1E293B", fontFamily: FONT_SANS }}
                    >
                      {row.aspect}
                    </span>
                    <span
                  ...
                  {isOpen && (
                    <div className="px-5 pb-5 space-y-3">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-slate-600 text-right max-w-[60%]" style={{ fontFamily: FONT_SANS }}>
                          {row.traditional}
                        </span>
                      </div>
                      <div
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-28">
          ...
          <div className="mt-12 grid lg:grid-cols-2 gap-6">
            ...
            <div
              ...
              style={{ background: "#1A2D42", border: "1px solid rgba(255,255,255,0.10)" }}
            >
              <p
              ...
              <h3 className="text-2xl font-semibold text-white mt-3" style={{ fontFamily: FONT_SANS }}>
            ...
            <div className="rounded-3xl p-6 sm:p-8" style={{ background: "#1A2D42", border: "2px solid #2563EB" }}>
              ...
              >
                ...
                <p className="text-xs leading-5" style={{ fontFamily: FONT_SANS, color: "rgba(251,191,36,0.9)" }}>
                  Your exact fee rate is confirmed during the application process based on your eligibility profile. You
                  will always see your rate clearly before you confirm anything. For most tenants it is 7%. On renewal,
                  it drops to 4% — loyalty is rewarded.
                </p>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-28">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-xs leading-6 mt-5" style={{ fontFamily: FONT_SANS, color: "rgba(255,255,255,0.55)" }}>
