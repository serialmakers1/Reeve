  ...
  return (
    <Layout>
      <div className="min-h-screen bg-white">
        {/* Section 1 — Hero */}
        <section className="lg:min-h-[calc(100vh-4rem)] pt-16 lg:pt-20 relative" style={{ background: "#0F1C2E" }}>
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
            <div className="flex flex-col lg:flex-row items-start lg:items-center py-12 lg:py-0 gap-8 lg:gap-12">
              ...
              <div className="w-full lg:w-[55%] flex flex-col justify-center lg:justify-start py-8 lg:py-16">
                ...
                >
                  Reeve is Bangalore&apos;s fully managed rental platform — for tenants who want a fair deal, and owners
                ...
                >
                  Reeve manages everything between owners and tenants — at no cost to owners. No brokers. No hidden
                  fees. Just a great home and a stress-free tenancy.
                </p>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-[#E8E4DC] rounded-3xl p-8 flex flex-col hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
                ...
                <p className="mt-2 text-sm text-slate-500 leading-relaxed" style={{ fontFamily: FONT_SANS }}>
                  We charge a 7% Reeve Fee on each month’s rent (dropping to 4% when you renew) — instead of a
                  broker&apos;s 1–2 months. You save significantly on day one.
                </p>
              ...
              <div className="bg-[#0F1C2E] rounded-3xl p-8 flex flex-col hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
                ...
                <p className="mt-2 text-sm text-slate-400 leading-relaxed" style={{ fontFamily: FONT_SANS }}>
        ...
        <section className="bg-[#2563EB] py-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl lg:text-5xl font-bold text-white text-balance">Ready to rent smarter?</h2>
            ...
            <p className="text-white/60 text-sm mt-6">₹0 Brokerage · 2 Month Deposit · Fully Managed for Free</p>
          </div>
        </section>
      </div>
    </Layout>
