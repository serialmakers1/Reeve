...
const COMPARISON_ROWS: ComparisonRow[] = [
  {
    aspect: "Brokerage",
    selfManaged: "₹0 but you do all the work",
    broker: "1–2 months rent per cycle",
    reeve: "₹0 — always",
  },
  {
    aspect: "Visits required from you",
    selfManaged: "10–15 per cycle",
    broker: "5–10 per cycle",
    reeve: "Zero",
    emphasized: true,
  },
  {
    aspect: "Maintenance",
    selfManaged: "You coordinate everything",
    broker: "Not their problem",
    reeve: "Platform handles end-to-end",
  },
  { aspect: "Your time spent", selfManaged: "40+ hours/year", broker: "10–15 hours/year", reeve: "Near zero" },
  {
    aspect: "Cost to owner",
    selfManaged: "₹0 direct, high time cost",
    broker: "₹30K–₹1L+ per cycle",
    reeve: "₹0 — always",
  },
];
...
function calculateSavings(rent: number): SavingsResult {
  ...
  const traditionalNetCost = LISTING_FEE + commission + turnoverExpense - depositAbsorbed;
  return {
    rent,
    commission,
    turnoverExpense,
      ...
      <div style={{ background: C.bg, fontFamily: FONT_SANS, color: C.textPrimary }}>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              ...
              <div>
                ...
                >
                  Every Sunday drive to show the flat to someone who doesn&apos;t show up. Every broker fee that
                  disappears after the deal. Every tenant call you didn&apos;t ask for. There is a better way — and it
                  costs you nothing.
                </p>
                ...
                >
                  Your tenants pay only 2 month deposit. That means faster occupancy, lower vacancy risk, and
                  better-quality tenants who aren&apos;t stretched thin from day one.
                </p>

                <div className="owner-fade-up mt-6 flex flex-wrap gap-2" style={{ animationDelay: "240ms" }}>
                  {["Free Listing", "Zero Commission", "Zero Management Fee", "No Owner-Side Charges — Ever"].map(
                    (b) => (
                      <span
                        key={b}
        ...
        <section style={{ background: C.bgLight }} className="py-10 sm:py-16 lg:py-28">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              <div className="rounded-3xl p-8 lg:p-10" style={{ background: C.accent }}>
                ...
                <p className="mt-6 text-sm leading-relaxed text-white opacity-80">
                  You pay nothing to list. You pay nothing when a tenant is found. You pay no monthly management fee, no
                  commission, and no platform retainer — ever.
                </p>
                <p className="mt-4 text-sm leading-relaxed text-white opacity-80">
                  Your full rent amount is transferred to your bank account every month. Nothing is deducted on your
                  end.
                </p>
                <span
              ...
              >
                ...
                <div className="mt-6 space-y-4">
                  {[
                    {
                      icon: "💰",
                      title: "Tenants pay a 7% Reeve fee on top of rent",
            ...
            <p className="mt-8 text-center text-sm" style={{ color: C.textDarkMuted }}>
              &ldquo;Reeve&apos;s business model only works when your property is leased. That&apos;s not a coincidence
              — it&apos;s intentional.&rdquo;
            </p>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  body: "Fill a quick form or give us a call. No photos, no documents, no preparation needed at this stage. Just your name, phone number, property area, and BHK. That's it.",
                  pill: null,
                },
                {
                  n: "2",
                  title: "We Inspect & List",
                  body: "Our team visits, photographs, documents every detail, and lists your property professionally. We show it to every vetted applicant — you are never asked to be present for a single viewing.",
                  pill: null,
                },
                {
                  n: "3",
                  title: "Tenant Moves In",
                  body: "You review and approve the tenant application. We handle the digital agreement, key handover, and move-in condition report. Police verification for foreign citizens is handled by us.",
                  pill: null,
                },
                {
                  n: "4",
                  title: "We Manage Everything",
                  body: "Rent collected and transferred to you every month. Maintenance coordinated end-to-end. Move-out inspections conducted. Lease renewals managed. Your only job is to receive your payout.",
                  pill: null,
                },
              ].map((step, i, arr) => (
                <div key={step.n} className="flex gap-5">
                  <div className="flex flex-col items-center">
                    ...
                    {i < arr.length - 1 && <div className="my-1 w-px flex-1" style={{ background: C.borderLight }} />}
                  </div>
                  <div className="pb-10">
                    <h3 className="font-semibold text-lg" style={{ color: C.textDark }}>
                      {step.title}
                    </h3>
                    <p className="mt-2 text-sm leading-relaxed text-left" style={{ color: C.textDarkBody }}>
                      {step.body}
                    </p>
                    {step.pill && (
                      <span
                ...
                {[
                  {
                    n: "1",
                    title: "Submit Your Property",
                    body: "Fill a quick form or give us a call. No photos, no documents, no preparation needed at this stage. Just your name, phone, property area, and BHK.",
                    pill: null,
                  },
                  {
                    n: "2",
                    title: "We Inspect & List",
                    body: "Our team visits, photographs, lists your property, and shows it to every vetted applicant. You are never asked to be present for a single viewing.",
                    pill: null,
                  },
                  {
                    n: "3",
                    title: "Tenant Moves In",
                    body: "You review and approve the tenant. We handle the digital agreement, key handover, and move-in condition report.",
                    pill: null,
                  },
                  {
                    n: "4",
                    title: "We Manage Everything",
                    body: "Rent transferred to you on the 5th. Maintenance coordinated. Disputes handled. Move-out inspections done. Your only job: receive your payout.",
                    pill: null,
                  },
                ].map((step) => (
                  <div key={step.n} className="flex flex-col items-center text-center">
                    ...
                    <h3 className="mt-5 font-semibold text-base" style={{ color: C.textDark }}>
                      {step.title}
                    </h3>
                    <p className="mt-2 text-sm leading-relaxed text-left" style={{ color: C.textDarkBody }}>
                      {step.body}
        ...
        <section id="calculator" style={{ background: C.bg }} className="py-10 sm:py-16 lg:py-28">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            {/* Slider card */}
            <div
              className="mt-10 rounded-3xl p-8 lg:p-10"
            ...
            >
              ...
              >
                ...
                <span className="text-xl font-normal" style={{ color: C.textMuted }}>
                  {" "}
                  /month
                </span>
              </p>
              ...
              <div className="mt-6 px-1">
                ...
                <div className="relative mt-2 h-5">
                  {/* Left label */}
                  <span className="absolute left-0 text-xs" style={{ color: C.textMuted }}>
                    ₹20,000
                  </span>

                  {/* Right label */}
                  <span className="absolute right-0 text-xs" style={{ color: C.textMuted }}>
                    ₹2,00,000
                  </span>
                  ...
                  <div
                    ...
                    style={{
                      left: `${((50000 - MIN_RENT) / (MAX_RENT - MIN_RENT)) * 100}%`,
                  ...
                  <div
                    className="hidden sm:flex flex-col items-center absolute"
                    style={{
                      left: `${((100000 - MIN_RENT) / (MAX_RENT - MIN_RENT)) * 100}%`,
                      transform: "translateX(-50%)",
                    }}
                  >
                    <div className="h-2 w-px" style={{ background: C.border }} />
                  ...
                  <div
                    className="hidden sm:flex flex-col items-center absolute"
                    style={{
                      left: `${((150000 - MIN_RENT) / (MAX_RENT - MIN_RENT)) * 100}%`,
                      transform: "translateX(-50%)",
                    }}
                  >
                    <div className="h-2 w-px" style={{ background: C.border }} />
                ...
                <div className="p-6" style={{ background: C.surface }}>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      {
                        label: "Painting & Cleaning Expense (0.5× rent)",
                        value: null,
                        animated: true,
                        raw: savings.turnoverExpense,
                      },
                    ].map((row) => (
                      <div
                        key={row.label}
                        className="flex justify-between rounded-xl px-4 py-3 text-sm"
                        style={{ background: C.dangerBg, border: `1px solid ${C.dangerBorder}` }}
                      >
                    ...
                    <div
                      className="flex justify-between rounded-xl px-4 py-3 text-sm font-bold"
                      style={{ background: C.dangerBg, border: `1px solid ${C.dangerBorder}` }}
                    >
                      <span style={{ color: C.danger }}>Net Cost</span>
                      <AnimatedNumber
                        value={savings.traditionalNetCost}
                        formatter={formatINR}
                        className="font-bold"
                        style={{ color: C.danger } as React.CSSProperties}
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-10 text-center">
              ...
              >
                You save <AnimatedNumber value={savings.netSavings} formatter={formatINR} /> in direct costs.
              </p>
            </div>
            ...
            >
              <strong>Assumptions:</strong> 11-month tenure cycle · Traditional listing fee ₹10,000 · Painting &amp;
              Cleaning Expense 0.5× monthly rent · Deposit absorbed by owner at turnover: 1× monthly rent (offsets
              cleaning cost).
            </div>
          </div>
        </section>
        ...
        >
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
              ...
              {[
                {
                  num: "120",
                  label: "Hours",
                  desc: "saved managing your property — coordinating maintenance, chasing rent",
                },
                {
                  num: "15",
                  label: "Visits",
                  desc: "saved showing your property — viewings, check-ins, move-out walkthroughs you never have to make",
                },
                {
                  num: "₹0",
                  label: "Broker fees",
                  desc: "across the entire relationship — not just this tenant cycle, but every renewal and re-leasing",
                },
              ].map((card) => (
                <div
                  key={card.label}
                ...
                >
                  <p className="text-[56px] font-bold leading-none" style={{ fontFamily: FONT_MONO, color: C.accent }}>
                    {card.num}
                  </p>
                  <p
                    className="mt-2 text-xs font-semibold uppercase tracking-widest"
                    style={{ color: C.textDarkMuted }}
                  >
                    {card.label}
                  </p>
            ...
            >
              ...
              <br />
              But you&apos;ve felt every one of them.&rdquo;
            </p>
          </div>
        </section>
        ...
        <section style={{ background: C.bg }} className="py-10 sm:py-16 lg:py-28">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            {/* Desktop table */}
            <div
              className="mt-10 hidden lg:block overflow-hidden rounded-2xl"
                ...
                <thead>
                  <tr>
                    <th
                      ...
                      style={{ color: C.textMuted, background: C.surface }}
                    >
                      Aspect
                    </th>
                    <th
                      className="px-6 py-4 text-center font-semibold"
                      style={{ color: C.textBody, background: C.surface }}
                    >
                      Self-managed
                    </th>
                    <th
                  ...
                  {COMPARISON_ROWS.map((row, i) => (
                    ...
                    >
                      <td
                        ...
                        style={{
                          color: row.emphasized ? C.accentMid : C.textPrimary,
                      ...
                      <td
                        ...
                        style={{ color: C.textBody, borderBottom: `1px solid ${C.border}` }}
                      >
                        {row.selfManaged}
                      </td>
                      <td
                      ...
                      <td
                        className="px-6 py-4 text-center font-semibold"
                        style={{ color: C.accentMid, background: C.accentLight, borderBottom: `1px solid ${C.border}` }}
                      >
                        ✓ {row.reeve}
                      </td>
                    </tr>
                  ...
                  >
                    ...
                    >
                      <span
                        ...
                        style={{ color: row.emphasized ? C.accentMid : C.textPrimary }}
                      >
                        {row.aspect}
                      </span>
                      <span
        ...
        <section style={{ background: C.bgLight }} className="py-10 sm:py-16 lg:py-28">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="mt-4 text-[20px] leading-[30px]" style={{ fontFamily: FONT_SERIF, color: C.textDark }}>
                We&apos;re just getting started in Bangalore. Be among the first 10 owners to list with Reeve — and
                we&apos;ll give your property priority placement, dedicated onboarding, and our full attention from day
                one.
              </p>
        ...
        <section style={{ background: C.accent }} className="py-16 sm:py-20">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="mt-4 text-base" style={{ color: "rgba(255,255,255,0.75)", fontFamily: FONT_SANS }}>
            ...
            <p className="mt-6 text-sm" style={{ color: "rgba(255,255,255,0.5)", fontFamily: FONT_SANS }}>
